...
DEFAULT_TITLE = "STAR WARS X SANTA"
...
# DEPARTMENTS = [
#     "Select Department",
#     "Digital & IT", "HR", "Tendering",
#     "QHSC", "Marketing", "Sales",
...
DEPARTMENTS = [
    ...
    "CIVIL & STRUCTURAL",
    "COMMERCIAL",
    "COMMISSIONING MAINTENANCE & INSPECTION ENGINEERING",
    "COMPENSATION DEVELOPMENT AND TRASFORMATION",
    "CONSTRUCTION",
    "CONTRACT MANAGEMENT",
    ...
    "ENGINEERING",
    "ESTIMATING",
    "EXPEDITING INSPECTION AND MATERIAL MANAGEMENT",
    "FLOATING VESSELS AND MMO PROCUREMENT",
    "GENERAL SERVICES",
    ...
    "HSE SERVICES",
    "HSE SYSTEM",
    "HUMAN RESOURCES ADMINISTRATION AND LABOUR COST",
    "HUMAN RESOURCES AND ORGANISATION",
    "HUMAN RESOURCES SERVICES",
    "IMMIGRATION AND EXPATRIATE MANAGEMENT",
    "INSTRUMENTATION, AUTOMATION AND TELECOMMUNICATION",
    "INTEGRATE DESIGN & FEASIBILITY",
    "LAYOUT & PIPING",
    "LOGISTICS",
    ...
    "MODULARIZATION AND FLOATERS STRUCTURAL",
    "MUMBAI CENTRE",
    "OFFSHORE ENGINEERING",
    "OFFSHORE PIPING, ELECTRICAL AND INSTRUMENTATION",
    "OFFSHORE STRUCTURAL",
    "PROCESS",
    "PROCESS AND TECHNOLOGIES",
    "PROCESS TECHNICAL SAFETY & EQUIPMENT",
    "PROCUREMENT SYSTEMS AND REPORTING SERVICES",
    "PROJECT AND COMPANY PROCUREMENT",
    ...
    "VENDOR MANAGEMENT AND MARKET INTELLIGENCE SERVICES"]
